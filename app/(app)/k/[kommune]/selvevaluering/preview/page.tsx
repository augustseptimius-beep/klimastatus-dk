...
export default async function SelvevalueringPreviewPage({ params }: Props) {
  ...
  if (!saved) redirect(`/k/${slug}/selvevaluering`);
    ...
    <>
      ...
      <div style={{ padding: '24px 32px', maxWidth: 1100 }}>
        <div className="no-print" style={{ display: 'flex', gap: 12, marginBottom: 24, alignItems: 'center' }}>
          <Link href={`/k/${slug}/selvevaluering`} style={{ fontSize: 13, color: 'var(--ink-500)' }}>← Tilbage</Link>
          <PrintButton />
        </div>

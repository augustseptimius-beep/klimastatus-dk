...
type Props = {
  ...
  action: (data: { publicEnabled: boolean; publicStaleDays: number; publicHighlights: string[] }) => Promise<{ ok: boolean; error?: string }>;
};
...
export function PublicConfigForm({
  ...
  function handleSave() {
    startTransition(async () => {
      const result = await action({ publicEnabled: enabled, publicStaleDays: staleDays, publicHighlights: highlights });
